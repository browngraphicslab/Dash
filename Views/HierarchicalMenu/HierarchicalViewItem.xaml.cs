...
namespace Dash
{
    public sealed partial class HierarchicalViewItem : UserControl
    {
        ...
        public void Deactivate()
        {
            ...
            xText.Foreground = new SolidColorBrush(Colors.DimGray) {Opacity = 0.3};
            xIcon.Foreground = new SolidColorBrush(Colors.DimGray) {Opacity = 0.3};
            xCollapseExpandButton.Foreground = new SolidColorBrush(Colors.DimGray) {Opacity=0.3};
            IsActive = false;
        }
