...
//        {
//            _operator.UpdateInputs(args.NewValue as OperatorController);
//        }

//        private void AutoSuggestBox_OnTextChanged(AutoSuggestBox sender, AutoSuggestBoxTextChangedEventArgs args)
//        {
//            var key = sender.DataContext as KeyController;
//            var coll = _operatorDoc.GetField(key)?.DereferenceToRoot<ListController<DocumentController>>(null)?.GetDocuments();
//            if (coll == null)
//            {
//                return;
//            }
