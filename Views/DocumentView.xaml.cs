...
namespace Dash
{
    public sealed partial class DocumentView
    {
        ...
        public DocumentView()
        {
            ...
            PointerCanceled += (s, e) =>
            {
                if (e != null && e.Pointer.PointerDeviceType == PointerDeviceType.Touch && s != null &&
        ...
        public void CopyDocument(Point? where = null)
        {
            using (UndoManager.GetBatchHandle())
            {
                ParentViewModel?.AddDocument(ViewModel.DocumentController.GetCopy(where));
            }
        }
        /// <summary>
        /// Copies the Document.
        ...
        public void MakeInstance(Point? where = null)
        {
            using (UndoManager.GetBatchHandle())
            {
                ParentViewModel?.AddDocument(ViewModel.DocumentController.GetDataInstance(where));
            }
        }
        /// <summary>
        /// Copes the DocumentView for the document
        /// </summary>
        public void CopyViewDocument(Point? where = null)
        {
            using (UndoManager.GetBatchHandle())
            {
                ParentViewModel?.AddDocument(ViewModel.DocumentController.GetViewCopy(where));
            }
        }
