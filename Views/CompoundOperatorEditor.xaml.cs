...
namespace Dash
{
    public sealed partial class CompoundOperatorEditor : UserControl
    {
        ...
        private FreeFormCollectionViewModel _freeFormCollectionViewModel;
        ...
        public CompoundOperatorEditor()
        {
            ...
            _freeFormCollectionViewModel = new FreeFormCollectionViewModel(false);
            xFreeFormEditor.DataContext = _freeFormCollectionViewModel;
        }
