...
namespace Dash
{
    public class RichEditView : RichEditBox
    {
        ...
        public static readonly DependencyProperty TextWrappingProperty = DependencyProperty.Register(
            "TextWrapping", typeof(TextWrapping), typeof(RichEditView), new PropertyMetadata(default(TextWrapping), xRichEditView_TextWrappingChangedCallbackStatic));
        ...
        private void XRichEditBox_OnKeyDown(object sender, KeyRoutedEventArgs e)
        {
            ...
            if (e.Key == (VirtualKey)191) // 191 = '/' 
            {
                if (actionMenu == null)
                {
                    ...
                    if (rt == "" || rt == "#" || rt == "/" || (Document.Selection.EndPosition - Document.Selection.StartPosition) >= rt.Length)
                    {
