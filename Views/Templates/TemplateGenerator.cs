...
<Grid
    ...
    <StackPanel Orientation=""Horizontal""  Grid.Row=""2"" Height=""30"" Background=""White"" >
        ...
        <dash:EditableTextBlock x:Name=""xTextField1"" Text=""author"" HorizontalAlignment=""Stretch"" VerticalAlignment=""Center"" Padding=""0 0 5 0"" />
        ...
        <TextBlock x:Name=""xTextField2"" Text=""created"" HorizontalAlignment=""Stretch"" VerticalAlignment=""Center"" />
    </StackPanel>
</Grid>"),
                    }, DocumentType.DefaultType),
                    new DocumentController(new Dictionary<KeyController, FieldControllerBase>{
