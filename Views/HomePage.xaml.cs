...
namespace Dash
{
    ...
    public sealed partial class HomePage : Page
    {
        ...
        private void OnCreateOrGetHomePage(object sender, TappedRoutedEventArgs e)
        {
            ...
            RESTClient.Instance.Documents.GetDocumentsByQuery<DocumentModel>(new DocumentTypeLinqQuery(DashConstants.TypeStore.HomePageType), Success, exception => throw exception);
        }
