...
namespace Dash
{
    public class IOReference
    {
        ...
        public IOReference(KeyController fieldKey, FieldReference fieldReference, bool isOutput, TypeInfo type, PointerRoutedEventArgs args, FrameworkElement e, DocumentView container)
        {
            FieldKey = fieldKey;
