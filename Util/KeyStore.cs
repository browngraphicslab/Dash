...
namespace Dash
{
	public class KeyStore
	{
	    ...
	    public static KeyController DocumentBehaviorsKey                 = KeyController.Get("_Document Behaviors");
	    ...
	    public static KeyController LeftTappedOpsKey                     = KeyController.Get("_Left Tapped Ops");
