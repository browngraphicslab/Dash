...
namespace Dash
{
	public class KeyStore
	{
        ...
        public static KeyController CollectionItemLayoutPrototypeKey = new KeyController("CollectionItemLayoutPrototype", "7C6F72BA-EC97-4DA5-8ACE-5F4F1118F185"); // layout prototype shared by each item in a collection -- set using TableExtraction, used in CollectionPageView
        public static KeyController LayoutPrototypeKey = new KeyController("LayoutPrototype", "77805171-247D-4485-A257-1751619C2C45");                             // layout prototype used by a document - set using TableExtraction, used in CollectionDBSchema
        public static KeyController ColumnSortingKey = new KeyController("ColumnSort", "852DBACD-791C-422B-8B8E-5EC5E7E8DCA2");                                    // list containing column name and direction to sort a schema table
