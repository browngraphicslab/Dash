...
namespace Dash
{
    public static class CourtesyDocuments
    {
        ...
        public class CourtesyDocument
        {
            ...
            public Dictionary<Key, FieldModelController> DefaultLayoutFields(double x, double y, double w, double h,
        ...
        public class TwoImages : CourtesyDocument
        {
            ...
            static DocumentController CreatePrototypeLayout()
            {
                ...
                _prototypeTwoImages = new DocumentController(fields, TwoImagesType);
                ...
                var prototypeImage1Layout = new ImageBox(new ReferenceFieldModelController(_prototypeTwoImages.GetId(), Image1FieldKey), 0, 20, 200, 200);
                var prototypeImage2Layout = new ImageBox(new ReferenceFieldModelController(_prototypeTwoImages.GetId(), Image2FieldKey), 0, 220, 200, 200);
                ...
                var cBox = new CollectionBox(new DocumentCollectionFieldModelController(new[] { prototypeTextLayout.Document,
                                                                                                prototypeImage1Layout.Document,
                                                                                                prototypeImage2Layout.Document })).Document;
                SetLayoutForDocument(_prototypeTwoImages, cBox);
                return cBox;
            }
            static int times = 0;
            public TwoImages(bool displayFieldsAsDocuments)
            {
                ...
                {
                    fields.Add(Image1FieldKey, new ImageFieldModelController(new Uri("ms-appx://Dash/Assets/cat2.jpg")));
                    fields.Add(Image2FieldKey, new ImageFieldModelController(new Uri("ms-appx://Dash/Assets/cat.jpeg")));
                    fields.Add(TextFieldKey, new TextFieldModelController("Bye World!"));
                }

                foreach (var f in fields)
                {
                    Document.SetField(f.Key, f.Value, true);
                }
