    ...
    public static class CourtesyDocuments {
        ...
        public class LayoutCourtesyDocument : CourtesyDocument {
            ...
            public LayoutCourtesyDocument(DocumentController docController, Context context) {
                ...
                var layoutField = docController.GetDereferencedField(DashConstants.KeyStore.ActiveLayoutKey, context) as DocumentFieldModelController;
                if (layoutField == null) {
        ...
        public class TwoImages : CourtesyDocument {
            ...
            static DocumentController CreatePrototypeLayout()
            {
                ...
                var prototypeRichTextLayout = new RichTextBox(new DocumentReferenceController(_prototypeTwoImages.GetId(),RichTextKey), 0,450,200,200);
                var prototypeLayout = new StackingPanel(new[] { prototypeTextLayout.Document, prototypeImage1Layout.Document, prototypeTextLayout.Document, prototypeImage2Layout.Document, prototypeRichTextLayout.Document }, true);
