...
/// <summary>
/// This class provides an empty implementation of <see cref="IDashSearchGrammarListener"/>,
...
public partial class DashSearchGrammarBaseListener : IDashSearchGrammarListener {
	...
	public virtual void EnterAnd_token([NotNull] DashSearchGrammarParser.And_tokenContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="DashSearchGrammarParser.and_token"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitAnd_token([NotNull] DashSearchGrammarParser.And_tokenContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="DashSearchGrammarParser.or_token"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterOr_token([NotNull] DashSearchGrammarParser.Or_tokenContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="DashSearchGrammarParser.or_token"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitOr_token([NotNull] DashSearchGrammarParser.Or_tokenContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="DashSearchGrammarParser.operator"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterOperator([NotNull] DashSearchGrammarParser.OperatorContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterPhrase([NotNull] DashSearchGrammarParser.PhraseContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterKv_search([NotNull] DashSearchGrammarParser.Kv_searchContext context) { }
	/// <summary>
