...
namespace Dash
{
    public class NestedDocExample : CourtesyDocument
    {
        ...
        public static KeyControllerBase TextField2Key = new KeyControllerBase("B53F1453-4C52-4302-96A3-A6B40DA7D587", "TextField2");
        public static KeyControllerBase TwoImagesKey = new KeyControllerBase("4E5C2B62-905D-4952-891D-24AADE14CA80", "TowImagesField");
