...
namespace Dash
{
    ...
    public class LayoutModel
    {
        ...
        public LayoutModel(IDictionary<string, object> fields, string type)
        {
            ...
            Fields.Add("Type", new ElementModel(-10000, -1000));
            DocumentType = type;
            foreach (var val in fields)
                if (!Fields.ContainsKey(val.Key))
                    Fields.Add(val.Key, new ElementModel(-10000, -1000));
        }
        ...
        /// <returns></returns>
        public static LayoutModel Food2ForkRecipeModel(DocumentModel doc)
        {
