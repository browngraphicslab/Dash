...
namespace Dash
{
    ...
    public sealed class ToLowerOperator : OperatorController
    {
        ...
        public ToLowerOperator() : base(new OperatorModel(TypeKey.KeyModel)) => SaveOnServer();
        ...
        private static readonly KeyController TypeKey = new KeyController("ToLower", new Guid("502F54E3-D2AF-46FF-91E9-42B9A00C7E9D"));
