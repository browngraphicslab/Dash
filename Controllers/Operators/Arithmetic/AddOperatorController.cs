...
namespace Dash
{
    public class AddOperatorController : OperatorController
    {
        ...
        //Input keys
        public static readonly KeyController AKey = new KeyController("942F7A38-3E5D-4CD7-9A88-C61B962511B8", "Number A");
        public static readonly KeyController BKey = new KeyController("F9B2192D-3DFD-41B8-9A37-56D818153B59", "Number B");
