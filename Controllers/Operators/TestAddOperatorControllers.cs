...
namespace Dash
{
    ...
    public class TestAddOperatorControllerFour : OperatorController
    {
        ...
        private static readonly KeyController TypeKey = new KeyController("Test Add four param", "0DB9818C-75C4-4EE6-A237-8DBCDCA7C28F");
    ...
    public class TestAddOperatorControllerOne : OperatorController
    {
        ...
        public override KeyController OperatorType { get; } = TypeKey;
        private static readonly KeyController TypeKey = new KeyController("Test Add one param", "DABC33AD-193C-4434-AF77-33CA87F26BB5");
    ...
    public class TestAddOperatorControllerInheritanceA : OperatorController
    {
        ...
        public override KeyController OperatorType { get; } = TypeKey;
        private static readonly KeyController TypeKey = new KeyController("Test Add inheritance-based ambiguity", "21509C51-0134-421B-A1A7-4833DCAFCDC4");
    ...
    public class TestAddOperatorControllerInheritanceB : OperatorController
    {
        ...
        public override KeyController OperatorType { get; } = TypeKey;
        private static readonly KeyController TypeKey = new KeyController("Test Add inheritance-based ambiguity", "BC3963BC-9AFC-4122-823F-2427FE54B336");
