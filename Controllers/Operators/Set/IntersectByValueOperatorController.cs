...
namespace Dash
{
    ...
    public class IntersectByValueOperatorController : OperatorController
    {
        ...
        public IntersectByValueOperatorController() : base(new OperatorModel(OperatorType.IntersectByValue))
        {
        }
        ...
        {
            [SetAKey] = new IOInfo(TypeInfo.List, true),
            [SetBKey] = new IOInfo(TypeInfo.List, true)
        };
