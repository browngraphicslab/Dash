...
namespace Dash
{
    ...
    public abstract class OperatorController : FieldModelController<OperatorModel>
    {
        ...
        /// </summary>
        /// <returns></returns>
        public abstract void Execute(Dictionary<KeyController, FieldControllerBase> inputs, Dictionary<KeyController, FieldControllerBase> outputs, FieldUpdatedEventArgs args, Scope scope = null);
