...
{
    public sealed partial class ProfilePopup : UserControl, ICustomTemplate
    {
        private ObservableCollection<string> fields = new ObservableCollection<string>();
        public ProfilePopup(IEnumerable<string> hashFields)
        {
        ...
        public Task<List<string>> GetLayout()
        {
            ...
            void XConfirmButton_OnClick(object sender, RoutedEventArgs e)
            {
                var input = new List<string>
                {
                    ...
                    xThirdHeader.Text,
                    fields.ElementAtOrDefault(xTextField7.SelectedIndex)
                };
