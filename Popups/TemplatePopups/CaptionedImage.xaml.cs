...
{
    public sealed partial class CaptionedImage : UserControl, ICustomTemplate
    {
        private ObservableCollection<string> fields = new ObservableCollection<string>();
        public CaptionedImage(IEnumerable<string> hashFields)
        {
        ...
        public Task<List<string>> GetLayout()
        {
            ...
            void XConfirmButton_OnClick(object sender, RoutedEventArgs e)
            {
                ...
                {
                    fields.ElementAtOrDefault(xImageFieldData.SelectedIndex),
                    fields.ElementAtOrDefault(xRichTextFieldCaption.SelectedIndex),
                };
