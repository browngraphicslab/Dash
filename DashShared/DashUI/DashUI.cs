namespace DashShared
{
    ...
    public class FontWeights
    {
        ...
        public static FontWeight Light => new FontWeight(100);
        ...
        public static FontWeight Normal => new FontWeight(100);
